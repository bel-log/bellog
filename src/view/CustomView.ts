...
import { BuilderFactory } from "../app/builders/BuilderFactory";
import { CustomBuilder } from "../app/builders/CustomBuilder";
import { HexStringBuilder } from "../app/builders/HexStringBuilder";
import { LineBuilder } from "../app/builders/LineBuilder";
import { BuildHtmlComponent, buildResolverResultKeys } from "../app/setup/SetupFactories";
import { SetupCustomHtmlProperties, SetupBindingType, ViewSetupMatchElementProperties, ViewSetupMatchResolverProperties, ViewSetupMatchResolverType, ViewSetupProperties, SetupBindingPropertiesCode, SetupBindingPropertiesGui, WidgetSetupProperties, WidgetGroupSetupProperties, HtmlComponentEventType, ActionProperties, SetupCustomBuilderProperties } from "../app/setup/SetupInterfaces";
                ...
                switch (matcher.resolver) {
                    ...
                    case ViewSetupMatchResolverType.Any:
                        if (typeof data === "string") {
                            ...
                            str = Buffer.from(data).toString('hex');
                        }
