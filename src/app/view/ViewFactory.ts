...
import { ActionProperties, SetupCustomBuilderProperties, SetupCustomHtmlProperties, ViewSetupProperties, WidgetGroupSetupProperties } from "../setup/SetupInterfaces";
