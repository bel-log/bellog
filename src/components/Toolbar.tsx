...
export const Toolbar = (props: { children: React.ReactNode }) => {
    ...
    return (
        <ToolbarContext.Provider value={[toolbarState, setToolbarState]}>
            <nav className="navbar is-primary is-unselectable" role="navigation" aria-label="main navigation">
                ...
                <div className={`navbar-menu ${burgetActive ? "is-active" : ""}`}>
                    ...
                    <div className={`${burgetActive ? "is-hidden" : ""}`}
                    style={{ position: "relative", display: "flex", flexDirection: "row", flex: "1", justifyContent: "center", alignItems: "center" }}>
                        {
